...
Measured: default vs `-DGGML_CPU_KLEIDIAI=ON` on Neoverse-N2 → 187.36 vs 185.47 tok/s prefill
(−1.0%, noise) and 43.44 vs 43.59 tok/s decode (+0.3%, noise). KleidiAI is a **no-op** on
