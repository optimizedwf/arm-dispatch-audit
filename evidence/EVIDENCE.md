...
|---|---|---|
| default (no KleidiAI) | **187.36 ± 0.26** | **43.44 ± 0.15** |
| + KleidiAI (GGML_CPU_KLEIDIAI=ON) | 185.47 ± 0.37 | 43.59 ± 0.06 |

Δ = **−1.01% prefill / +0.35% decode** — KleidiAI is a no-op (or slightly worse) on 128-bit Neoverse.
